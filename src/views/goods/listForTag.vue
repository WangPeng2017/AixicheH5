...
<script>
  ...
  import { getGoodsListForTag } from '@api'
  ...
  export default {
    ...
    methods: {
      ...
      async loadGoods (page) {
        ...
        let res = await getGoodsListForTag(qs.stringify(this.postData))
      ...
      initMeScroll () {
        ...
        this.$nextTick(() => {
          if (this.meScroll) {
            ...
            this.meScroll = new MeScroll('taggoods_mescroll', {
              up: {
                callback (page) {
                  self.loadGoods(page)
                },
