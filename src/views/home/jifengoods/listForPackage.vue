<template>
  <div class="view">
    ...
    <div class="content">
      <div class="mescroll" id="packagegoods_mescroll">
        <div class="scroll">
          <goods-card v-for="item in data" :key="item.id" :data="item" :consumption_types="$route.query.consumption_types" :type="display"></goods-card>
        </div>
